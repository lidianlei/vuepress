...
<p>下面是 FLEX 系统兼容性数据，你也可以在 <a href="https://caniuse.com/" target="_blank" rel="noopener noreferrer">https://caniuse.com/ (opens new window)<ExternalLinkIcon/></a>网站查看，绝大多数设备尤其是移动端都很好的支持 FLEX，所以可以放心使用</p>
<h2 id="容器的属性" tabindex="-1"><a class="header-anchor" href="#容器的属性" aria-hidden="true">#</a> 容器的属性</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>声明内联级弹性盒子</strong></p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token selector">article</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img :src="$withBase('/images/flex/01.png')" alt="foo">
<table>
<thead>
<tr>
...
<td style="text-align:left">（默认值）主轴为水平方向，起点在左端</td>
</tr>
<tr>
<td style="text-align:left">row-reverse</td>
<td style="text-align:left">主轴为水平方向，起点在右端</td>
</tr>
<tr>
<td style="text-align:left">column</td>
<td style="text-align:left">主轴为垂直方向，起点在上沿</td>
</tr>
<tr>
<td style="text-align:left">column-reverse</td>
<td style="text-align:left">主轴为垂直方向，起点在下沿</td>
</tr>
</tbody>
</table>
<h3 id="flex-wrap" tabindex="-1"><a class="header-anchor" href="#flex-wrap" aria-hidden="true">#</a> flex-wrap</h3>
<p>flex-wrap 属性规定 flex 容器是单行或者多行，同时横轴的方向决定了新行堆叠的方向</p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token selector">.box</span><span class="token punctuation">{</span>
...
<td style="text-align:left">不换行（默认值）</td>
</tr>
<tr>
...
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token selector">.box</span> <span class="token punctuation">{</span><span class="token property">flex-flow</span><span class="token punctuation">:</span> &lt;flex-direction> || &lt;flex-wrap><span class="token punctuation">;</span><span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>justify-content</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img :src="$withBase('/images/flex/02.png')" alt="foo">
<table>
<thead>
<tr>
<th style="text-align:left">选项</th>
...
<h3 id="交叉轴行" tabindex="-1"><a class="header-anchor" href="#交叉轴行" aria-hidden="true">#</a> 交叉轴行</h3>
<p>元素在交叉轴上有行的概念，理解这个概念会对理解 align-items 与 align-content 有更好的帮助。</p>
<ul>
<li>align-item 是控制元素在行上的排列</li>
<li>align-content 是控制行在交差轴上的排列</li>
</ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img :src="$withBase('/images/flex/03.png')" alt="foo">
<table>
<thead>
<tr>
<th style="text-align:left">选项</th>
...
<td style="text-align:left">（默认值）如果项目未设置高度或设为auto，将占满整个容器的高度</td>
</tr>
<tr>
<td style="text-align:left">center</td>
<td style="text-align:left">交叉轴的中点对齐</td>
</tr>
<tr>
<td style="text-align:left">flex-start</td>
<td style="text-align:left">交叉轴的起点对齐</td>
</tr>
<tr>
<td style="text-align:left">flex-end</td>
<td style="text-align:left">交叉轴的终点对齐</td>
</tr>
<tr>
<td style="text-align:left">baseline</td>
<td style="text-align:left">项目的第一行文字的基线对齐</td>
</tr>
</tbody>
</table>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img :src="$withBase('/images/flex/04.png')" alt="foo">
<table>
<thead>
<tr>
<th style="text-align:left">选项</th>
...
<h2 id="弹性元素" tabindex="-1"><a class="header-anchor" href="#弹性元素" aria-hidden="true">#</a> 弹性元素</h2>
<p>放在容器盒子中的元素即为容器元素。</p>
<ul>
<li>不能使用 float 与 clear 规则</li>
<li>弹性元素均为块元素</li>
...
<p>align-self<code v-pre>属性允许单个项目有与其他项目不一样的对齐方式，可覆盖</code>align-items<code v-pre>属性。默认值为</code>auto<code v-pre>，表示继承父元素的</code>align-items<code v-pre>属性，如果没有父元素，则等同于</code>stretch</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="弹性文本" tabindex="-1"><a class="header-anchor" href="#弹性文本" aria-hidden="true">#</a> 弹性文本</h2>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>article</span><span class="token punctuation">></span></span>
    css
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>span</span><span class="token punctuation">></span></span>vue<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>span</span><span class="token punctuation">></span></span>
    css
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>article</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="绝对定位" tabindex="-1"><a class="header-anchor" href="#绝对定位" aria-hidden="true">#</a> 绝对定位</h2>
<p>绝对定位的弹性元素不参与弹性布局</p>
<h2 id="自动空间" tabindex="-1"><a class="header-anchor" href="#自动空间" aria-hidden="true">#</a> 自动空间</h2>
<p>在弹性布局中对元素使用<code v-pre>margin-right:auto</code> 等形式可以自动撑满空间。下例为第一个 ul 设置 <code v-pre>margin-right:auto</code> 表示右侧空间自动撑满，第二个 ul 靠近父元素右边界。</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
